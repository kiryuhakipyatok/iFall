...
func NewIPhoneReportService(ur repositories.UserRepository, l *logger.Logger, b bot.TelegramBot, es email.EmailSender, cfg config.IPhonesConfig) IphoneReportService {
